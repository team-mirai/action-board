...
VALUES
  ...
  ('1776d950-34f4-44e6-a5c5-2e40fa9038a3', '公式noteをフォローしよう', '/img/mission_fallback.svg', '<a href="https://note.com/annotakahiro24">公式note</a>をフォローして、チームみらいの活動の裏側や候補者の考え、政策に込めた想いをもっと深く知ろう！選挙ストーリーや解説記事など、SNSでは語りきれない情報が満載です。', 1, NULL, 'TEXT', 1, 'https://tibsocpjqvxxipszbwui.supabase.co/storage/v1/object/public/ogp//1_follow_note.png', 'あなたのnoteアカウント名'),
