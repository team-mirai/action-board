...
function XpProgressToastContent({
  userLevel,
  xpGranted,
  startLevel,
  startLevelStartXp,
  ...
  return (
    <div className="flex flex-col space-y-3 p-4 bg-white rounded-lg shadow-lg w-full max-w-sm mx-auto">
      ...
      <div className="flex items-center space-x-3">
        ...
        <span className="text-sm font-medium">Lv.{stageData.nextLevel}</span>
      </div>
    </div>
  );
}

export function showXpProgressToast(data: XpProgressToastData) {
  return toast.custom((t) => <XpProgressToastContent {...data} />, {
    duration: 4000,
    position: "top-center",
  });
}
